...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/home/alexax/x-tools/aarch64-cortex_a53-linux-gnu/aarch64-cortex_a53-linux-gnu/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
